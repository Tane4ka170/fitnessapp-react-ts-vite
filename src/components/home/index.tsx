          ...
          <motion.div className="md:flex mx-auto w-5/6 items-center justify-center md:h-5/6" onViewportEnter={() => setSelectedPage(SelectedPage.Home)}>
              ...
              <div className=" z-10 mt-32 md:basis-3/5">
                ...
                visible:{opacity:1, x:0},  }}>
                      ...
                      <p className=" mt-8 text-sm md:text-start">Ultimate Fitness Center. Exceptional Training Programs. State-of-the-art Studios for Achieving Your Dream Physique.
                          Transform Your Body Today.</p>
                  </motion.div>
                  {/* Actions */}
                  <motion.div className="mt-8 flex items-center gap-8" initial='hidden' whileInView='visible' viewport={{ once: true, amount: 0.5 }} transition={{ delay:0.2, duration: 0.5 }} variants={{
                      hidden: { opacity: 0, x: -50 },
                visible:{opacity:1, x:0},  }}>
